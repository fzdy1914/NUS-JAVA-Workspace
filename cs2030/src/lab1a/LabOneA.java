...
class LabOneA {
  ...
  public static void readEvents(Scanner s, Simulator sim){
  ...
  public static void main(String[] args) {
    ...
    System.out.printf("%.3f %d %d\n", sim.getTotalWaitingTime() / sim.getTotalNumOfServedCustomer(),
        sim.getTotalNumOfServedCustomer(), sim.getTotalNumOfLostCustomer());
  }
