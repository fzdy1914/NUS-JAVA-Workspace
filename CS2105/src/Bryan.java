...
class Bryan {  // Bryan is a TCP server
    ...
    public void sendPublicKey() {
        try {
            ...
            MessageDigest pub_key = MessageDigest.getInstance("MD5");
            pub_key.update(pubKey.getEncoded());
            md5.update("bryan".getBytes("US-ASCII")); 
            md5.update(pub_key.digest());
            System.out.println(md5.digest().equals(digest));
